...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit):
        ...
        self.y_hat_g = (
            None  # the last generator prediction to be passed onto the discriminator
        )
    ...
    def train_step(
        self, batch: Dict, criterion: Dict, optimizer_idx: int
    ) -> Tuple[Dict, Dict]:
        ...
        if optimizer_idx == 0:
            ...
            loss_dict = criterion[optimizer_idx](
                y_hat, y, scores_fake, feats_fake, feats_real, y_hat_sub, y_sub
            )
    ...
    @staticmethod
    def _log(
        name: str, ap: AudioProcessor, batch: Dict, outputs: Dict
    ) -> Tuple[Dict, Dict]:
