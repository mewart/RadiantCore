...
class WaveNetDecoder(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, hidden_channels, c_in_channels, params
    ):
        super().__init__()
        # prenet
        ...
        # wavenet layers
        self.wn = WNBlocks(
            params["hidden_channels"], c_in_channels=c_in_channels, **params
        )
        # postnet
        self.postnet = [
...
class ResidualConv1dBNDecoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, hidden_channels, params):
        ...
        self.res_conv_block = ResidualConv1dBNBlock(
            in_channels, hidden_channels, hidden_channels, **params
        )
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        if decoder_type.lower() == "relative_position_transformer":
            ...
            self.decoder = FFTransformerDecoder(
